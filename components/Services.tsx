...
export default function Services() {
  return (
    <section id="services" className="py-24 px-6 bg-ink-900 border-y border-ink-700">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-px bg-ink-700 border border-ink-700 rounded-2xl overflow-hidden">
          {services.map((s) => (
            <div
              key={s.id}
              className="bg-ink-900 p-8 flex flex-col justify-between hover:bg-ink-800/60 transition group"
            >
              <div>
